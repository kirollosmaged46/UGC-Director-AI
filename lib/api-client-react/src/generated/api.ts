 ...
 */
export const getGenerateUgcContentUrl = () => {
  return `/api/ugc/generate`;
};

export const generateUgcContent = async (
  generateUgcBody: GenerateUgcBody,
  options?: RequestInit,
): Promise<GenerateUgcResponse> => {
  return customFetch<GenerateUgcResponse>(getGenerateUgcContentUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(generateUgcBody),
  });
};

export const getGenerateUgcContentMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateUgcContent>>,
    TError,
    { data: BodyType<GenerateUgcBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["generateUgcContent"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return generateUgcContent(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateUgcContentMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateUgcContent>>
>;
export type GenerateUgcContentMutationBody = BodyType<GenerateUgcBody>;
export type GenerateUgcContentMutationError = ErrorType<unknown>;

/**
 * @summary Generate UGC content from a product image
 */
export const useGenerateUgcContent = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGenerateUgcContentMutationOptions(options));
};

/**
 * @summary Generate social media hooks and captions
 */
export const getGenerateUgcHooksUrl = () => {
  return `/api/ugc/hooks`;
};

export const generateUgcHooks = async (
  generateHooksBody: GenerateHooksBody,
  options?: RequestInit,
): Promise<GenerateHooksResponse> => {
  return customFetch<GenerateHooksResponse>(getGenerateUgcHooksUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(generateHooksBody),
  });
};

export const getGenerateUgcHooksMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof generateUgcHooks>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["generateUgcHooks"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return generateUgcHooks(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GenerateUgcHooksMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateUgcHooks>>
>;
export type GenerateUgcHooksMutationBody = BodyType<GenerateHooksBody>;
export type GenerateUgcHooksMutationError = ErrorType<unknown>;

/**
 * @summary Generate social media hooks and captions
 */
export const useGenerateUgcHooks = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
